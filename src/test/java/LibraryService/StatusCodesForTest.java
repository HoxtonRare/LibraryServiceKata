...
public class StatusCodesForTest {
    ...
    public static final int ERROR_CODE_FOR_INCORRECT_GET = 1004;
    public static final String ERROR_MESSAGE_FOR_INCORRECT_GET = "Указанный автор не существует в таблице";
    public static final int ERROR_CODE_FOR_NULL_GET = 1001;
    ...
    public static final int ERROR_CODE_FOR_INCORRECT_POST = 1004;
    public static final int ERROR_CODE_FOR_NULL_POST = 1001;
